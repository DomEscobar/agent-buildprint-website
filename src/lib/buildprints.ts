...
const selectedOutputFiles = (paths: string[]): BuildprintFile[] => paths.map((path) => ({
  path,
  purpose: canonicalFilePurposes[path] ?? (path.startsWith('capabilities/') ? 'capability pack execution file' : 'selected Buildprint package file'),
  required: true,
}));
...
const toonflowAppFiles = selectedOutputFiles([
  ...
  'VERIFICATION.md',
  'buildprint.json',
  'capabilities/agent-memory-rag/CAPABILITY.md',
  'capabilities/agent-memory-rag/CONTRACTS.md',
  'capabilities/agent-memory-rag/IMPLEMENTATION.md',
  'capabilities/agent-memory-rag/VERIFICATION.md',
  'capabilities/asset-library-media-upload/CAPABILITY.md',
  'capabilities/asset-library-media-upload/CONTRACTS.md',
  'capabilities/asset-library-media-upload/IMPLEMENTATION.md',
  'capabilities/asset-library-media-upload/VERIFICATION.md',
  'capabilities/auth-api-access/CAPABILITY.md',
  'capabilities/auth-api-access/CONTRACTS.md',
  'capabilities/auth-api-access/IMPLEMENTATION.md',
  'capabilities/auth-api-access/VERIFICATION.md',
  'capabilities/database-backup-admin/CAPABILITY.md',
  'capabilities/database-backup-admin/CONTRACTS.md',
  'capabilities/database-backup-admin/IMPLEMENTATION.md',
  'capabilities/database-backup-admin/VERIFICATION.md',
  'capabilities/electron-docker-deployment/CAPABILITY.md',
  'capabilities/electron-docker-deployment/CONTRACTS.md',
  'capabilities/electron-docker-deployment/IMPLEMENTATION.md',
  'capabilities/electron-docker-deployment/VERIFICATION.md',
  'capabilities/image-generation-assets-storyboards/CAPABILITY.md',
  'capabilities/image-generation-assets-storyboards/CONTRACTS.md',
  'capabilities/image-generation-assets-storyboards/IMPLEMENTATION.md',
  'capabilities/image-generation-assets-storyboards/VERIFICATION.md',
  'capabilities/novel-ingestion-event-extraction/CAPABILITY.md',
  'capabilities/novel-ingestion-event-extraction/CONTRACTS.md',
  'capabilities/novel-ingestion-event-extraction/IMPLEMENTATION.md',
  'capabilities/novel-ingestion-event-extraction/VERIFICATION.md',
  'capabilities/production-agent-workbench/CAPABILITY.md',
  'capabilities/production-agent-workbench/CONTRACTS.md',
  'capabilities/production-agent-workbench/IMPLEMENTATION.md',
  'capabilities/production-agent-workbench/VERIFICATION.md',
  'capabilities/project-setup-model-selection/CAPABILITY.md',
  'capabilities/project-setup-model-selection/CONTRACTS.md',
  'capabilities/project-setup-model-selection/IMPLEMENTATION.md',
  'capabilities/project-setup-model-selection/VERIFICATION.md',
  'capabilities/script-agent-workspace/CAPABILITY.md',
  'capabilities/script-agent-workspace/CONTRACTS.md',
  'capabilities/script-agent-workspace/IMPLEMENTATION.md',
  'capabilities/script-agent-workspace/VERIFICATION.md',
  'capabilities/script-assets-extraction/CAPABILITY.md',
  'capabilities/script-assets-extraction/CONTRACTS.md',
  'capabilities/script-assets-extraction/IMPLEMENTATION.md',
  'capabilities/script-assets-extraction/VERIFICATION.md',
  'capabilities/skills-prompt-management/CAPABILITY.md',
  'capabilities/skills-prompt-management/CONTRACTS.md',
  'capabilities/skills-prompt-management/IMPLEMENTATION.md',
  'capabilities/skills-prompt-management/VERIFICATION.md',
  'capabilities/storyboard-flow-persistence/CAPABILITY.md',
  'capabilities/storyboard-flow-persistence/CONTRACTS.md',
  'capabilities/storyboard-flow-persistence/IMPLEMENTATION.md',
  'capabilities/storyboard-flow-persistence/VERIFICATION.md',
  'capabilities/vendor-provider-system/CAPABILITY.md',
  'capabilities/vendor-provider-system/CONTRACTS.md',
  'capabilities/vendor-provider-system/IMPLEMENTATION.md',
  'capabilities/vendor-provider-system/VERIFICATION.md',
  'capabilities/video-generation-workbench/CAPABILITY.md',
  'capabilities/video-generation-workbench/CONTRACTS.md',
  'capabilities/video-generation-workbench/IMPLEMENTATION.md',
  'capabilities/video-generation-workbench/VERIFICATION.md',
...
export const buildprints: Buildprint[] = [
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    featured: true,
    summary: 'Clean-room, Toonflow-inspired portable creative pipeline that maps novel chapters into events, staged scripts, storyboard rows, assets, jobs, and a product-grade creative workbench preview manifest.',
    plainDescription: 'A blueprint for a novel-to-storyboard workbench: import chapters, extract story events, generate staged scripts, create storyboard rows, render local visual fixtures, keep debug evidence secondary, and export a preview manifest.',
    whatYouGet: ['Novel-to-storyboard creative workbench workflow', 'Chapter import and event extraction', 'ScriptAgent-style script workspace', 'ProductionAgent-style storyboard rows', 'Local visual fixtures and selected-shot inspector', 'Mock image/video generation tasks with compact media state', 'Preview/export manifest and final chat handover'],
    ...
    promise: 'A validated mapped-project Buildprint for rebuilding the portable novel-to-storyboard workflow as a creative workbench without copying Toonflow source or claiming full clone/media-export parity.',
    includes: ['Portable workflow scope', 'Closed alignment questions and default storyboard preset', 'Numbered phase plans for LLM context control', 'LLM execution and context-rot guide', 'Product quality bar for creative workbench UX', 'Workbench UX and design system specs', 'Local visual fixture pack', 'Webapp target spec', 'ScriptAgent and ProductionAgent contracts', 'XML output contract and repair loop', 'Async job/cancellation model', 'Mock-first provider adapters', 'Preview composition manifest', 'Head-to-foot QA gate', 'Browser QA scenarios', 'Parity claims and explicit non-claims', 'Final chat handover requirement', 'Machine-readable phase/acceptance/claim gates'],
    ...
    files: [
      ...
      { path: 'SPEC.md', purpose: canonicalFilePurposes['SPEC.md'], required: true },
      { path: 'CONTRACTS.md', purpose: canonicalFilePurposes['CONTRACTS.md'], required: true },
      { path: 'PLAN.md', purpose: 'phase index for numbered LLM execution rails', required: true },
      { path: 'TEST_MATRIX.md', purpose: canonicalFilePurposes['TEST_MATRIX.md'], required: true },
      { path: 'VALIDATION_TEMPLATE.md', purpose: canonicalFilePurposes['VALIDATION_TEMPLATE.md'], required: true },
      { path: 'checks/acceptance.md', purpose: canonicalFilePurposes['checks/acceptance.md'], required: true },
      ...
      { path: 'DESIGN_SYSTEM_SPEC.md', purpose: 'visual design system for product-grade storyboard workbench UI', required: true },
      ...
      { path: 'OBSERVABILITY.md', purpose: 'Buildprint package file', required: true },
      ...
      { path: 'plans/00-alignment.md', purpose: 'phase rail', required: true },
      { path: 'plans/01-domain-persistence.md', purpose: 'phase rail', required: true },
      { path: 'plans/02-agent-xml-pipeline.md', purpose: 'phase rail', required: true },
      { path: 'plans/03-async-providers.md', purpose: 'phase rail', required: true },
      { path: 'plans/04-workbench-ui.md', purpose: 'phase rail', required: true },
      { path: 'plans/05-qa-handover.md', purpose: 'phase rail', required: true },
      ...
      { path: 'PRODUCT_QUALITY_BAR.md', purpose: 'product-grade creative workbench quality rail and forbidden debug-dashboard outcomes', required: true },
      ...
      { path: 'VISUAL_FIXTURE_PACK.md', purpose: 'deterministic local visual fixture requirements for mock/no-network previews', required: true },
    ...
    trustBadges: [
      ...
      { label: 'Creative workbench quality rail', detail: 'Requires storyboard thumbnails, timeline lanes, selected-shot inspector, compact media tiles, and debug drawer.', tone: 'success' },
      ...
      { label: 'Explicit parity + handover boundary', detail: 'Claims stop at workflow/contract/runtime proof and final chat handover must state evidence, gaps, and next direction.', tone: 'warning' },
    ],
    ...
    copyPrompt: `${localPrompt('portable-novel-storyboard-pipeline', 'Portable Novel-to-Storyboard Pipeline')} Build a clean-room portable creative storyboard workbench for the novel-to-storyboard workflow. Resolve alignment first using BUILDPRINT.md and PLAN.md. Execute PLAN.md in order to avoid context rot. Before UI work, reread PRODUCT_QUALITY_BAR.md, LLM_AGENT_EXECUTION_GUIDE.md, and WORKBENCH_UX_SPEC.md. Use mock/no-network providers by default and deterministic local visual fixtures for primary previews. The browser UI must be a creative workbench, not a compliance dashboard: show storyboard thumbnails, timeline lanes, selected-shot inspector, compact media tiles, and a secondary debug drawer. Keep task logs, raw refs, limitations, and manifest JSON secondary. Produce a PortablePreviewManifest/preview package only; do not claim Toonflow clone, provider parity, exact workbench parity, Electron parity, or final stitched-video export parity unless explicitly upgraded with evidence. Fill validation evidence and finish with a chat handover containing outcome, evidence, known gaps, and recommended next direction.`,
  },
  {
    slug: 'toonflow-app',
    title: 'Toonflow Full-Suite Source-Independent Mapping',
    creator: 'Agent Buildprint',
    category: 'Mapped Project',
    tier: 'agent-grade',
    status: 'dry-run-needed',
    runtime: ['Node.js/Electron-compatible target', 'Full-stack app runtime proof required', 'Provider-backed media generation gates'],
    stack: ['Novel ingestion', 'Script agents', 'Asset extraction', 'Storyboard workbench', 'Provider system', 'Electron/Docker deployment'],
    iconKeys: ['typescript', 'json', 'md'],
    difficulty: 'Advanced',
    featured: true,
    ...
    githubUrl: `${repoUrl}/tree/main/buildprints/toonflow-app`,
    originGithubUrl: 'https://github.com/HBAI-Ltd/Toonflow-app',
    originLabel: 'HBAI-Ltd/Toonflow-app',
