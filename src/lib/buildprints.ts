...
export const buildprints: Buildprint[] = [
...

  {
    ...
    trustBadges: [
      ...
      { label: 'Dry-run needed', detail: 'Package is publishable as a blueprint but not yet validated by a clean-room runnable proof.', tone: 'warning' },
    ],
