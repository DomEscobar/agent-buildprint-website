...
export const buildprints: Buildprint[] = [
...

  {
    ...
    files: [
      { path: 'README.md', purpose: 'package overview and claim boundary', required: true },
      { path: 'BUILDPRINT.md', purpose: canonicalFilePurposes['BUILDPRINT.md'], required: true },
      ...
      { path: 'TRANSCRIPT_EVAL_REPORT.md', purpose: 'Codex clean-room transcript eval report', required: true },
      { path: 'CRITICAL_REVIEW.md', purpose: 'critical review of proof limits and risks', required: true },
      { path: 'questions.md', purpose: canonicalFilePurposes['questions.md'], required: true },
...

  {
    ...
    files: [
      { path: 'README.md', purpose: 'package overview and source basis', required: true },
      { path: 'BUILDPRINT.md', purpose: canonicalFilePurposes['BUILDPRINT.md'], required: true },
      { path: 'SPEC.md', purpose: canonicalFilePurposes['SPEC.md'], required: true },
      { path: 'PLAN.md', purpose: canonicalFilePurposes['PLAN.md'], required: true },
      { path: 'CONTRACTS.md', purpose: canonicalFilePurposes['CONTRACTS.md'], required: true },
      ...
      { path: 'TOOL_COMPARISON.md', purpose: 'which source tools map to which evaluation layers', required: true },
      { path: 'TEST_MATRIX.md', purpose: canonicalFilePurposes['TEST_MATRIX.md'], required: true },
...

  {
    ...
    files: [
      ...
      { path: 'ADVANCED_TECHNIQUES.md', purpose: 'HyDE, SPLADE, ColBERT, RAPTOR, GraphRAG, Self-RAG, CRAG, and contextual retrieval guidance', required: true },
      { path: 'EVAL_HARNESS.md', purpose: 'retrieval, answer, and operational eval contract', required: true },
      { path: 'VALIDATION_REPORT.md', purpose: 'research and proof validation status', required: true },
      { path: 'questions.md', purpose: canonicalFilePurposes['questions.md'], required: true },
      { path: 'proof/package.json', purpose: 'offline proof scripts', required: false },
      { path: 'proof/package-lock.json', purpose: 'offline proof dependency lockfile', required: false },
      { path: 'proof/tsconfig.json', purpose: 'offline proof TypeScript config', required: false },
  ...
  },
  {
    ...
    files: [
      ...
      { path: 'VALIDATION_REPORT.md', purpose: 'Codex dry-run result and blueprint gaps', required: true },
      { path: 'proof/README.md', purpose: 'dry-run proof instructions', required: false },
