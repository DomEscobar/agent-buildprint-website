...
export const buildprints: Buildprint[] = [
  ...
  },
  {
    ...
    difficulty: 'Advanced',
    featured: true,
    summary: 'Agent-session workflow for turning an existing repo into scoped, source-independent Buildprints with capability packs, execution protocol, and verification evidence.',
