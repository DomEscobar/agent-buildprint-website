...
export const buildprints: Buildprint[] = [
  ...
  },
  {
    ...
    files: [
      ...
      { path: 'templates/DESIGN_QUALITY_BAR.md', purpose: 'UI visual quality bar, taste variables, and screenshot gates', required: true },
      ...
      { path: 'templates/teams/integration-runtime.md', purpose: 'team-pack rule template for provider, API, and runtime paths', required: true },
      ...
      { path: 'templates/UX_CONTRACT.md', purpose: 'UI workflow, state, responsive, accessibility, and browser proof template', required: true },
