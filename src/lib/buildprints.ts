...
export const buildprints: Buildprint[] = [
  ...
  },
  {
    ...
    files: [
      ...
      { path: 'DECOMPOSITION_STRATEGY.md', purpose: 'Buildprint package file', required: true },
      ...
      { path: 'FEATURE_SCOPE_CONTRACT.md', purpose: 'Buildprint package file', required: true },
      { path: 'IMPLEMENTATION_PLAN.md', purpose: 'Buildprint package file', required: true },
      ...
      { path: 'templates/HEAD_TO_FOOT_QA.md', purpose: 'Buildprint package file', required: true },
      ...
      { path: 'templates/PARITY_CLAIMS.md', purpose: 'Buildprint package file', required: true },
      ...
      { path: 'templates/RUNTIME_LIVE_TEST_PLAN.md', purpose: 'Buildprint package file', required: true },
